...
| 1002 | Validation required                        | The request was not executed, but could not be validated. Signer does not support the standard used by the request, but validation argument was not provided.                  | (optional) Error details: <ul> <li>`message` (`text`, optional): message</li> </ul> |
| 1003 | Validation failed                          | The request was not executed, but validation failed.                         | (optional) Error details: <ul> <li>`message` (`text`, optional): message</li> </ul> |
