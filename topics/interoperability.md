...
| R5  | Users should be able to list and revoke granted permissions.                                                                    | Users should have access to infrastructure which allows them to:<ul><li>list of all active permissions the user has granted.</li><li>revoke the granted permissions. Revocation must take effect within a reasonably short timeframe (e.g. 5 minutes).</li></ul>This infrastructure should be available independently of the dapps used.                                                                                                                                                                                                                                                                                                                                                               |                                                     |
